...
router.post('/register', async (req, res) => {
    ...
    try {
       ...
       const newUser = await db.query(
            'INSERT INTO "USER" (username, name, password, email, phone, github, linkedin, photo) VALUES ($1, $2, $3, $4, $5, $6, $7, $8) RETURNING *',
    ...
    try {
        ...
        res.status(200).json({ message: 'Login bem-sucedido', token, user: user.rows[0] });
    } catch (error) {
